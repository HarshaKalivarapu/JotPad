// ============================================================================
// ARCHIVED — JotPad's original hand-rolled contentEditable editor.
//
// This was the first editor implementation: bold/italic via regex on **/*,
// bullet lists built from raw <ul>/<li> DOM manipulation, and manual cursor
// save/restore. It was replaced by the Tiptap-based src/components/Page.jsx.
// Kept here as a learning reference, and to have what I built before. 
// NOT imported or built by the app.
//
// Known rough edges (the reasons it was replaced): typing **text** could
// convert prematurely at the **text* stage, and deleting formatted text could
// leave empty <em> tags that trapped the cursor in an italic state.
// ============================================================================
